...
<body>
    <div class="container">
        ...
        <main class="content">
            ...
            <form action="index.php?controller=producto&action=store" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="tallas" name="tallas" placeholder="Ej: S,M,L,XL" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="precio_mayor" name="precio_mayor" step="0.01" required>
                </div>
                
                <div class="form-group">
                    <label for="precio_detal">Precio al Detal:</label>
                    <input type="number" id="precio_detal" name="precio_detal" step="0.01" required>
                </div>
